...
interface MyInterfaceInterface extends ethers.utils.Interface {
  functions: {
    "__LPTokenWrapper_initialize(address)": FunctionFragment;
    ...
    "stakeWithPermit(uint256,bytes)": FunctionFragment;
...
export class MyInterface extends BaseContract {
  ...
  interface: MyInterfaceInterface;
